...
// ═══════════════════════════════════════════════════════════════════════════
//MODULO 5.4 ENTREGA 
//La liberación del pago pasa cuando ejecutamos  capture() para acpturar el pago 
// no hay retención manual el dinero se transfiere en el ommento 
function iniciarEntrega() {
    const accionesEl = document.getElementById('entregaAcciones');
    if (!accionesEl) return;

    //Vvalida el rol
    //crear boton para subir el zip 
...
async function procesarZip(file) {
    ...
    try {
        //declaracion y funcion para procesar zip  
        ...
        //guardar estructura enn firestore 
